...
public class VenituriFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_venituri, container, false);
        iv_pieChart = view.findViewById(R.id.iv_pie_ven);
        ...
        iv_pieChart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("EXTRA_GRAPH_TYPE", "VENITURI");
